...
/**
 * Kim Bondo – Bedemand Amager (lokal SEO-landingsside)
 */
...
export default function KimAmager() {
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif", background: "#F9F8F6", color: "#2F3E46", margin: 0, padding: 0 }}>
      <SEO
        title="Bedemand Amager – Kim Bondo | Bisættelse og begravelse på Amager"
        description="Søger du en bedemand på Amager? Kim Bondo er personlig bedemand på Amager og i hele København. Hjælp til bisættelse, begravelse og afsked – gennemsigtige priser fra 15.500 kr. Ring 22 21 14 37 døgnet rundt."
        url="https://bedemandkbh-8wuvn9as.manus.space/kim-bondo/amager"
        image="https://bedemandkbh-8wuvn9as.manus.space/manus-storage/kim-beach-solo_609d5ab7.png"
      />
      <SchemaOrg type="both" faqItems={[
        { question: "Hvem er bedemand på Amager?", answer: "Kim Bondo er selvstændig bedemand og dækker Amager og hele København og Nordsjælland. Ring på 22 21 14 37 – tilgængelig døgnet rundt." },
...
`}</style>
      ...
      <section style={{ background: "#F9F8F6", padding: "72px 32px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          {[
            { q: "Hvem er bedemand på Amager?", a: "Kim Bondo er selvstændig bedemand og dækker Amager og hele København og Nordsjælland. Ring på 22 21 14 37 — tilgængelig døgnet rundt." },
      ...
      <section style={{ background: "#fff", padding: "40px 32px", textAlign: "center", borderTop: "1px solid #e0dcd6" }}>
        ...
        <a
          href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://bedemandkbh-8wuvn9as.manus.space/kim-bondo/amager")}`}
          target="_blank"
      ...
      <footer style={{ background: "#2F3E46", color: "#fff", textAlign: "center", padding: "80px 32px" }}>
        ...
        <p style={{ marginTop: "48px", fontFamily: "'Open Sans', sans-serif", fontSize: "12px", color: "rgba(255,255,255,0.30)" }}>
          © {new Date().getFullYear()} Kim Bondo – Bedemand Amager &nbsp;·&nbsp;
