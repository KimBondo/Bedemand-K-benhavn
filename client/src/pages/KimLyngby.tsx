...
/**
 * Kim Bondo – Bedemand Lyngby (lokal SEO-landingsside)
 */
...
export default function KimLyngby() {
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif", background: "#F9F8F6", color: "#2F3E46", margin: 0, padding: 0 }}>
      <SEO
        title="Bedemand Lyngby – Kim Bondo | Bisættelse og begravelse i Lyngby-Taarbæk"
        description="Søger du en bedemand i Lyngby? Kim Bondo hjælper familier i Lyngby-Taarbæk og omegn med bisættelse, begravelse og afsked. Personlig og nærværende hjælp – ring 22 21 14 37 døgnet rundt."
        url="https://bedemandkbh-8wuvn9as.manus.space/kim-bondo/lyngby"
      />
      <SchemaOrg type="both" faqItems={[
        { question: "Hvem er bedemand i Lyngby?", answer: "Kim Bondo er selvstændig bedemand og dækker Lyngby-Taarbæk Kommune og hele Nordsjælland. Ring på 22 21 14 37 – tilgængelig døgnet rundt." },
      ...
      <section style={{ background: "#F9F8F6", padding: "72px 32px 56px", textAlign: "center" }}>
        <p style={s.label}>Bedemand i Lyngby</p>
      ...
      <section style={{ background: "#fff", padding: "72px 32px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          {[
            { q: "Hvem er bedemand i Lyngby?", a: "Kim Bondo er selvstændig bedemand og dækker Lyngby-Taarbæk og hele Nordsjælland. Ring på 22 21 14 37 — tilgængelig døgnet rundt." },
