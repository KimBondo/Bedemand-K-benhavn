...
export default function KimKirkeligAfsked() {
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif", background: "#F9F8F6", color: "#2F3E46", margin: 0, padding: 0 }}>
      <SEO
        title="Kirkelig begravelse – Bedemand Kim Bondo"
        description="Kirkelig begravelse eller bisættelse med præst i København. Kim Bondo koordinerer kirke, kordegn og hele forløbet. Ring 22 21 14 37."
