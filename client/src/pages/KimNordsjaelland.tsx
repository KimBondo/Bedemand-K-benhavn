    ...
    <div role="main" style={{ fontFamily: "'Open Sans', sans-serif", background: "#F9F8F6", color: "#2F3E46", margin: 0, padding: 0 }}>
      ...
      <SchemaOrg
        ...
        breadcrumbs={[
          ...
          { name: "Bedemand Nordsjælland", url: "https://www.bedemandkobenhavn.dk/nordsjaelland/" },
        ]}
      />
...
`}</style>
        <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
          <a href="/" style={{ fontFamily: "'Lora', serif", fontWeight: 700, fontSize: "clamp(14px, 2.2vw, 20px)", color: "#2F3E46", letterSpacing: "0.03em", lineHeight: 1.2, textDecoration: "none" }}>Bedemand Nordsjælland</a>
      ...
      <section style={{ background: "#F9F8F6", padding: "72px 32px 56px", textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "'Open Sans', sans-serif", fontSize: "clamp(16px, 1.8vw, 20px)", color: "#5a7a6a", maxWidth: "660px", margin: "0 auto 40px", lineHeight: 1.7 }}>
          Jeg er selvstændig bedemand og dækker hele Nordsjælland. Jeg kører selv ud, også om aftenen og i weekenden — og I taler med den samme person hele vejen.
        </p>
      ...
      <section style={{ background: "#fff", padding: "72px 32px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <h3 style={{ ...s.h3, marginTop: "36px" }}>Kirkegårde, kapeller og krematorium i Nordsjælland</h3>
          <p style={s.body}>
            Hillerød Krematorium blev etableret i 1967 og udførte omkring 2.000 kremeringer i 2025. Det ligger ved Skansekirkegården på Skansevej, hvor der også er kapel med plads til 150 — ligesom i Nyhuse Kapel inde i byen.
          </p>
          <p style={s.body}>
            I Gentofte er Mariebjerg Kirkegård optaget i Kulturkanonen, og de to kapeller dér tager henholdsvis 150 og 50 personer. Helsingør Kirkegård har byens kapel fra 1903 med 165 pladser, og i Hørsholm ligger kapellet fra 1929, som kan benyttes af alle uanset tro. Jeg kender rummene og ved, hvor mange der kan være.
          </p>
